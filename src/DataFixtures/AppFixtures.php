...
class AppFixtures extends Fixture
{
    ...
    { 
        ...
        $user->setEmail('test@test.com')
             ->setRoles(['ROLE_ADMIN'])
             ->setPassword($this->encoder->encodePassword($user, "helloworld"));
        ...
        //Je vallide les modifications effectuées (insertions, modifications sur des enregistrements, etc..) dans la BDD
        $manager->flush();
